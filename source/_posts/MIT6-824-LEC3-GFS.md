---
title: MIT6.824-LEC3-GFS
date: 2019-05-21 14:26:55
tags:
- 分布式
- MIT6.824
categories: 
...
#	参考
本文写的非常简略，只是把一些重点摘抄出来，建议大家看看[这个](https://kb.cnblogs.com/page/174130/) 。
...
![GFS-Architecture](GFS-Architecture.png "GFS-Architecture")
一个典型的文件读操作是这样的：
...
![GFS-FRSAM](GFS-FRSAM.png "GFS-FRSAM")
...
![GFS-WCDF](GFS-WCDF.png "GFS-WCDF")
